...
if __name__ == "__main__":  # pragma: no cover
    ...
    t1 = time.timeit("insertion_sort(rev)",
                     number=reps,
                     setup="from __main__ import insertion_sort, rev")
    t2 = time.timeit("insertion_sort(fwd)",
                     number=reps,
                     setup="from __main__ import insertion_sort, fwd")
    t3 = time.timeit("insertion_sort(rand_sm)",
                     number=reps,
                     setup="from __main__ import insertion_sort, rand_sm")
    t4 = time.timeit("insertion_sort(rand_lg)",
                     number=reps,
                     setup="from __main__ import insertion_sort, rand_lg")
